...
function content_5cc553b470b574_90772633 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>文豆首页</title>
	<script type="text/javascript" src="http://www.smarty_wd.com/js/jquery-1.11.3.min.js"></script>
	<script src="http://www.smarty_wd.com/js/playImg.js"></script>
	<link rel="stylesheet" href="http://www.smarty_wd.com/css/reset.css">
	<link rel="stylesheet" href="http://www.smarty_wd.com/css/index.css">
	<link rel="stylesheet" href="http://www.smarty_wd.com/css/playImg.css">
</head>
<body>
	<div class="container">
		<a name="Top"></a>
		<header>
			<div class="head_nav" id="head_scroll">
				...
				<nav>
									...
									<a href="case_list.php">案例展示</a>
									<a href="about.php">关于我们</a>
									<a href="news_list.php">资讯动态</a>
		...
		<div class="case">
			...
			<i></i>
			<nav>
										<a href="?caid=1">企业品牌网站</a>
													<a href="?caid=2">电子商务网站</a>
													<a href="?caid=3" class="case_a">门户型网站</a>
													<a href="?caid=4">管理系统</a>
													<a href="?caid=5">团购</a>
									</nav>
			<ul>
							<li>
